...
##############Test Scenario 3 Stress testing (not so many scenarios, estimations are priority in reps) 
models = c("1PL","2PL","3PL")
items = c(200,500,1000)
individuals = c(10000)
s_reps = 50
...
scn = do.call(rbind,lapply(models,function(model)cbind(scn,model)))
...
scn0 = scn[order(scn$individuals,scn$items),]

models = c("1PL","2PL","3PL")
items = c(200,500,1000,2000,5000)
individuals = c(10000,100000)
s_reps = 1
s_function = c("f_mirt","f_sics")
